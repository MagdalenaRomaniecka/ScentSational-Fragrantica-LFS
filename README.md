...
# INTRO TEXT - RESTORED POETIC STYLE
st.markdown("""
...
if query and df is not None:
    ...
    with st.spinner("Decoding Vibe..."):
        ...
        # 2. Process
        processed_results = []
        # Safe tokenizer: lowercase, split by non-word chars to handle "warm, vanilla"
        ...
        for hit in hits[0]:
            ...
            # --- HIERARCHY LOGIC V10.0 (Smart Scoring) ---
            
            # 1. Complex Match (Count how many query words appear in Notes/Accords)
        ...
        # 3. SORTING STRATEGY:
        # - Match Count (Precision: Warm + Vanilla > Vanilla)
        # - AI Score (Vibe)
        # - Name Match
        # - Rating
...
<div class="custom-footer">
    ScentSational AI Core v10.1 &bull; Developed by Magdalena Romaniecka &bull; 2026<br>
