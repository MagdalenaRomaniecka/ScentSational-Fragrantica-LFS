...
@st.cache_data
def load_data():
    """Loads the main CSV dataset for Project B."""
    try:
        # CORRECTED FILENAME BASED ON USER SCREENSHOT
...
if not df.empty:
    ...
    if selected_brand != "All Brands" and 'Brand' in df.columns:
        ...
        filtered_df = df.head(50) # Show top 50 if no brand selected
    ...
    with col2:
        ...
        for index, row in filtered_df.iterrows():
            ...
            # Use 'Image URL' or fallback to 'Image' or placeholder
            link = str(row.get('Image URL', row.get('Image', '#'))) 
            ...
            st.markdown(f"""
                <div class="perfume-card">
                    ...
                    <div style="width:100%">
                        ...
                        <div class="row-rating">★ {float(rating):.2f}</div>
    ...
    st.warning("Dataset 'scentsational_data.csv' not found. Please ensure it is in the repository.")